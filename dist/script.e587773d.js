...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"javascript/data.json":[function(require,module,exports) {
module.exports = [{
  "title": "Work",
  "timeframes": {
    "daily": {
...
},{"./data.json":"javascript/data.json"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
